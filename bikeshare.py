...
def get_filters():
    ...
    while True:
      month = input("\n Kindly state the month you would you like to analyze: January, February, March, April, May, June or type 'all' if you do not have any preference?\n")
    ...
    while True:
      day = input("\n Kindly the day you want to analyse. Enter the day as follows: Sunday, Monday, Tuesday, Wednesday,`Thursday, Friday, Saturday or type 'all'\n")
...
def display_raw_data(df):
    ...
    print('\n    Want to see some raw data from the current dataset?')
    while True:
        ...
        if raw_data.lower() == 'y':
            ...
            print('\n    Want to see the next {} rows?'.format(show_rows))
            continue
        else:
            break
